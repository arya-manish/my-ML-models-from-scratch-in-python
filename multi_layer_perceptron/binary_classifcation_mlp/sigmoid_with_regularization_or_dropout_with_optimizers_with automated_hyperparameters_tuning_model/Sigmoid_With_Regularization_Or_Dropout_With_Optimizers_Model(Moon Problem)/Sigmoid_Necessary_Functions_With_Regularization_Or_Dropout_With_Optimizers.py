...
def regularized_or_dropout_optimizers_model_sigmoid(X, Y, layers_dims, minibatch_size, lambd, keep_prob, optimizer, num_epochs, learning_rate, beta1, beta2, epsilon = 1e-8):
